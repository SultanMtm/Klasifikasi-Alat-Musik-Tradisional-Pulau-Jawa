...
class PredictionengPage extends StatefulWidget {
  @override
  _PredictionengPageState createState() => _PredictionengPageState();
}

class _PredictionengPageState extends State<PredictionengPage> {
  File? _image;
  String _result = '';
  String _desc = '';
  ...
  Future<void> predictImage(File image) async {
    ...
    if (recognitions != null && recognitions.isNotEmpty) {
      ...
      if (confidence >= 0.9) {
        setState(() {
          _result = label;
          _desc = classInfo[label] ?? "Description not Found";
        });
      } else {
        setState(() {
          _result = "Not a Traditional Musical Instrument of Java Island";
          _desc = '';
        });
      }
    }
